                ...
                <div class="n_content_left" >
                    <div id="news_view_head" class="news_view_head">
                        <div class="news_view_title">
                            <h1>
                                <span id='ShoveWebControl_Text2'>{{ $project->title }}</span>
                            </h1>
                        </div>
                        <div class="news_view_date">
                            <span id='ShoveWebControl_Text3'>{{ $project->created_at }}</span>
                        </div>
                    </div>
                                ...
                                <div class="xn_c_newsv_9_cocnt">
                                    ...
                                    <div class="xn_c_newsv_9_li">
                                        <div class="xn_c_newsv_9_cocntlft">
                                            <a title='艺乡建' href="{{ route('projects.show', ['id' => $item->id]) }}" target="_blank">
                                                <img  data-original='{{ config('filesystems.disks.oss.cdnDomain') . '/' . $item->cover }}' src="{{ config('filesystems.disks.oss.cdnDomain') . '/' . $item->cover }}" alt='艺乡建' title='艺乡建' />
                                            </a>
                                        </div>
