                    ...
                    <ul id="left_typeUl_t400" class="left_typeUl left_typeUl_t400">
                        <li id="left_typeLi_t400_1" data_id="4_30" class="left_menu1 @if(request()->fullUrl() == route('view-internal-office')) left_menu1_cur @endif" type="t" index=1 level=0>
                            <a href="{{ route('view-internal-office') }}" target="_self">
                                <span name="ShoveWebControl_VMenu21051382564|T_NewsTypes|Id|30|Name"style="font-size:20px;">国内办公室</span>
                            </a>
                            <ul id="left_typeUl_t4301"  expend=0 class="left_typeUl left_typeUl_t4301">
                                <li id="left_typeLi_t4301_1" data_id="4_162" class="left_menu2" type="t" index=1 level=1><a href="" target="_self"><span name="ShoveWebControl_VMenu21855249497|T_NewsTypes|Id|162|Name"style="font-size:18px;">北京</span></a>
                                </li>
                                <li id="left_typeLi_t4301_2" data_id="4_163" class="left_menu2" type="t" index=2 level=1><a href="" target="_self"><span name="ShoveWebControl_VMenu2426718980|T_NewsTypes|Id|163|Name"style="font-size:18px;">湖北</span></a>
                                </li>
                                <li id="left_typeLi_t4301_3" data_id="4_164" class="left_menu2" type="t" index=3 level=1><a href="" target="_self"><span name="ShoveWebControl_VMenu21944844007|T_NewsTypes|Id|164|Name"style="font-size:18px;">杭州</span></a>
                                </li>
                                <li id="left_typeLi_t4301_4" data_id="4_165" class="left_menu2" type="t" index=4 level=1><a href="" target="_self"><span name="ShoveWebControl_VMenu269328530|T_NewsTypes|Id|165|Name"style="font-size:18px;">运城</span></a>
                                </li>
                            </ul>
                        </li>
                        <li id="left_typeLi_t400_2" data_id="4_140" class="left_menu1" type="t" index=2 level=0><a href="{{ route('view-overseas-office') }}" target="_self"><span name="ShoveWebControl_VMenu21689490442|T_NewsTypes|Id|140|Name"style="font-size:20px;">国外办公室</span></a>
                            <ul id="left_typeUl_t41401" style="display:none" expend=0 class="left_typeUl left_typeUl_t41401">
                                <li id="left_typeLi_t41401_1" data_id="4_167" class="left_menu2" type="t" index=1 level=1><a href="CaseSt_dj.html" target="_self"><span name="ShoveWebControl_VMenu2835542704|T_NewsTypes|Id|167|Name"style="font-size:18px;">加拿大</span></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
