<div id="ea_h">
    <!--style="background: url(/img/index_h_background.png)"-->
    <div class="top" >
        <div class="t_t"  >
            <div id="t_logo" class="t_logo" @if(request()->fullUrl() == route('projects.register')) style="position:absolute; top: 0; left:0;" @endif>
