            ...
            <div class="index_cnt_m" >
                ...
                <div id="xn_c_index_507_wrap" class="xn_c_index_507_wrap"     >
                    ...
                    <div class="xn_c_index_507_inner">
                        ...
                        <div id="xn_c_index_507_nums" class="xn_c_index_507_nums">
                            <div class="xn_c_index_507_curr">01</div>
                            <div class="xn_c_index_507_numm">/</div>
                            <div class="xn_c_index_507_count">5</div>
                        </div>
                    </div>
                </div>

                <!-- 多张图的拼贴   乡建视野-->  <!--多余的图片还有别的我们先不动-->
                                ...
                                <li class="xn_c_index_180_list">
                                    <div class="xn_c_index_180_img">
                                        <a href="{{ route('view.office.show', ['id' => 'bj']) }}" target="_blank">
                                            <img data-original='img/shiyebu_bj.png' alt='北京事业部' title='北京事业部' />
                                        </a>
                                    </div>
                                ...
                                <li class="xn_c_index_180_list">
                                    <div class="xn_c_index_180_img">
                                        <a href="{{ route('view.office.show', ['id' => 'hb']) }}" target="_blank">
                                            <img data-original='img/shiyebu_hb.png' />
                                        </a>
                                    </div>
                                    <div class="xn_c_index_180_cont">
                                        <a href="{{ route('view.office.show', ['id' => 'hb']) }}" target="_blank">
                                ...
                                <li class="xn_c_index_180_list">
                                    <div class="xn_c_index_180_img">
                                        <a href="{{ route('view.office.show', ['id' => 'hz']) }}" target="_blank">
                                            <img data-original='img/shiyebu_hz.png' />
                                        </a>
                                    </div>
                                    <div class="xn_c_index_180_cont">
                                        <a href="{{ route('view.office.show', ['id' => 'hz']) }}" target="_blank">
                                ...
                                <li class="xn_c_index_180_list">
                                    <div class="xn_c_index_180_img">
                                        <a href="{{ route('view.office.show', ['id' => 'yc']) }}" target="_blank">
                                            <img data-original='img/shiyebu_yc.png'/>
                                        </a>
                                    </div>
                                    <div class="xn_c_index_180_cont">
                                        <a href="{{ route('view.office.show', ['id' => 'yc']) }}" target="_blank">
                            ...
                            <ul class="xn_c_index_303_tUl" id="xn_c_index_303_tUl">
                                <li class="xn_c_index_303_tLi">
                                    <div class="xn_c_index_303_timg">
                                        <img data-original='/Private/NewsImgs/6367467527202948981595248309.jpg' alt=''>
                                    </div>
                                    <div class="xn_c_index_303_tWrap1">
                                        <div class="xn_c_index_303_tName1">
                                            项目决策委员会
                                        </div>
                                        <div class="xn_c_index_303_tName2">
                                            URBAN RESOURCES
                                        </div>
